...
#query = re.sub(r'\s+$', '', query) # remove trailing white spaces
	...
	if "check1" in form:
		...
		if lange == "NULL":
			#http://localhost:8983/solr/gettingstarted/select?q=Barcas&rows=1000&wt=json&indent=true
	...
	fullQuery = "http://localhost:8983/solr/gettingstarted/select?wt=json&indent=true"
...
for key in links:
	...
	if counter<=20:
		print "<tr>"
		print "<td style=\"display:1;\">" + key + "<br>" + " <a href=" + links[key] + ">" +  links[key] + "</a></td>"
		print "</tr>"
	else:
		print "<tr>"
		print "<td style=\"display:none;\">" + key + "<br>" + " <a href=" + links[key] + ">" +  links[key] + "</a></td>"
		print "</tr>"		
